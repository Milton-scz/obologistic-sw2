...
class ReporteController extends Controller
{
    public function index()
    {
        ...
        $montoTotalEnviado = Guia::sum('precio_total');
        ...
        $paquetesPorDia = Guia::selectRaw('DATE(fecha_salida) as fecha, COUNT(*) as cantidad')
            ->groupBy('fecha')
            ->get();

        // Cantidad de paquetes enviados por mes
        $paquetesPorMes = Guia::selectRaw('YEAR(fecha_salida) as año, MONTH(fecha_salida) as mes, COUNT(*) as cantidad')
            ->groupBy('año', 'mes')
            ->get();

        // Cantidad de paquetes enviados por año
        $paquetesPorAño = Guia::selectRaw('YEAR(fecha_salida) as año, COUNT(*) as cantidad')
            ->groupBy('año')
            ->get();
